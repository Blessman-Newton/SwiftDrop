...
class _RestaurantDetailScreenState extends ConsumerState<RestaurantDetailScreen>
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            const Icon(Icons.add, color: _onPrimaryContainer, size: 18),
                            if (qtyInCart > 0)
                              Positioned(
                                right: 0,
                                top: 0,
  ...
  List<Map<String, dynamic>> _getExtrasForFood(String foodName) {
  ...
  Widget _buildSheetCounter({required int value, required VoidCallback onDecrement, required VoidCallback onIncrement}) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        GestureDetector(
