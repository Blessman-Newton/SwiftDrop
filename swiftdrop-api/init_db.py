...
async def seed_categories():
    ...
    async with async_session() as session:
        ...
        categories = [
            ...
            {"name": "Desserts", "slug": "desserts", "display_order": 4},
            {"name": "Drinks", "slug": "drinks", "display_order": 5},
            {"name": "African", "slug": "african", "display_order": 6},
            {"name": "Asian", "slug": "asian", "display_order": 7},
            {"name": "Italian", "slug": "italian", "display_order": 8},
            {"name": "Mexican", "slug": "mexican", "display_order": 9},
            {"name": "Indian", "slug": "indian", "display_order": 10},
            {"name": "Chinese", "slug": "chinese", "display_order": 11},
            {"name": "Thai", "slug": "thai", "display_order": 12},
            {"name": "Japanese", "slug": "japanese", "display_order": 13},
            {"name": "Korean", "slug": "korean", "display_order": 14},
            {"name": "Mediterranean", "slug": "mediterranean", "display_order": 15},
            {"name": "American", "slug": "american", "display_order": 16},
            {"name": "French", "slug": "french", "display_order": 17},
            {"name": "Spanish", "slug": "spanish", "display_order": 18},
            {"name": "Greek", "slug": "greek", "display_order": 19},
            {"name": "Turkish", "slug": "turkish", "display_order": 20},
        ]
...
async def seed_test_restaurant(merchant_id):
    ...
    async with async_session() as session:
        ...
        restaurant = Restaurant(
            ...
            address="123 Osu Oxford Street, Accra, Ghana",
            phone="+233201234567",
